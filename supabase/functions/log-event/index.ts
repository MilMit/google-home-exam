...
Deno.serve(async(req)=>{
  ...
  try{
    ...
    const allowed=['tab_hidden','tab_visible','window_blur','window_focus','network_offline','network_online','camera_started','camera_stopped','fullscreen_enter','fullscreen_exit','copy_attempt','paste_attempt','question_view']
